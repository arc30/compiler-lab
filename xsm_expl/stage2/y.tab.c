...
#line 3 "syntaxtree.y" /* yacc.c:339  */
...
{
  "$end", "error", "$undefined", "OPERATOR", "NUM", "ID", "END", "BEG",
  "CONNECTOR", "READ", "WRITE", "PLUS", "MINUS", "MUL", "DIV", "ASSGN",
  "'('", "')'", "';'", "$accept", "program", "slist", "stmt", "inputstmt",
  "outputstmt", "assgnstmt", "expr", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,   267,   268,   269,   270,    40,    41,    59
};
# endif
...
{
      -6,    29,     8,   -11,   -16,     3,     5,    35,   -16,   -16,
     -16,   -16,   -16,    -2,    15,    -2,   -16,   -16,   -16,   -16,
      -2,     4,    -8,    12,    19,    -2,    -2,    -2,    -2,   -16,
       9,    10,   -16,    -7,    -7,   -16,   -16,   -16,   -16
};
...
{
      23,     1,    18,    19,    13,    24,    27,    28,    12,    30,
      33,    34,    35,    36,    20,    25,    26,    27,    28,    14,
      22,    15,    29,    25,    26,    27,    28,    37,    38,    31,
      25,    26,    27,    28,     3,     4,    32,    17,     5,     6,
       3,    16,     0,     0,     5,     6
};

static const yytype_int8 yycheck[] =
{
      15,     7,     4,     5,    15,    20,    13,    14,     0,    17,
      25,    26,    27,    28,    16,    11,    12,    13,    14,    16,
       5,    16,    18,    11,    12,    13,    14,    18,    18,    17,
      11,    12,    13,    14,     5,     6,    17,     7,     9,    10,
       5,     6,    -1,    -1,     9,    10
};
...
{
       0,     7,    20,     5,     6,     9,    10,    21,    22,    23,
      24,    25,     0,    15,    16,    16,     6,    22,     4,     5,
      16,    26,     5,    26,    26,    11,    12,    13,    14,    18,
      17,    17,    17,    26,    26,    26,    26,    18,    18
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 28 "syntaxtree.y" /* yacc.c:1646  */
    {		
